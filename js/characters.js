...
(function (global) {
  ...
  const CHARACTERS = {
    sun_xiaochuan: {
      ...
      photo: 'assets/img/sun_xiaochuan.webp',
      // v2.1 美术重制：风格化立绘优先于照片
      art: 'assets/img/art/characters/sun.webp',
      tagline: '嘴炮输出 · 网络梗 · 爆发',
      maxHp: 500,
      attack: 39,
      defense: 20,
    ...
    takaichi_sanae: {
      ...
      name: '高市早苗',
      emoji: '👩‍💼',
      photo: 'assets/img/takaichi_sanae.webp',
      art: 'assets/img/art/characters/sanae.webp',
  ...
  const ITEM_DEFS = {
    red_packet: {
      ...
      name: '回血红包',
      icon: '🧧',
      art: 'assets/img/art/icons/item_hp.webp',
    ...
    purify_spray: {
      ...
      name: '净化喷雾',
      icon: '💦',
      art: 'assets/img/art/icons/item_spray.webp',
      desc: '移除所有负面状态。'
    },
    energy_coffee: {
      id: 'energy_coffee',
      name: '能量咖啡',
      icon: '☕',
      art: 'assets/img/art/icons/item_coffee.webp',
      desc: '恢复 2 AP（不超过 10）。'
    }
  };
